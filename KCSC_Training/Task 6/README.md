...
```
Bài này là một bài cơ bản về command injection. Review source code ta được: 

![image](https://user-images.githubusercontent.com/104350480/227525978-6c664ea9-1eb5-4a0a-b573-58781cf09281.png)

Có thể thấy không hề có sanitize input nhập vào nên ta có thể thực hiện command injection ở đây được: 
